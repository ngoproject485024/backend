...
import { gmails, gmailsSchema } from './entities/gmail.entity';

@Module({
  imports: [MongooseModule.forRoot(''),
  MongooseModule.forFeature([{ name: 'educations', schema: EducationSchema },
  { name: 'gmail', schema: gmailsSchema }
    , { name: 'pages', schema: pagesSchema }, { name: 'events', schema: EventsSchema }, { name: 'ngo', schema: ngoSchema }, { name: 'document', schema: documentSchema }, { name: 'project', schema: projectSchema }]),],
